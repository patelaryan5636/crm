...
const performerRows = [
  { name: "Riya Sharma",    leads: "148", conversions: "42", revenue: "₹1,86,000", target: "93%",  status: "Completed" },
  { name: "Arjun Mehta",    leads: "132", conversions: "38", revenue: "₹1,62,000", target: "90%",  status: "Completed" },
  { name: "Priya Kulkarni", leads: "121", conversions: "31", revenue: "₹1,38,000", target: "86%",  status: "Completed" },
  { name: "Karan Verma",    leads: "109", conversions: "27", revenue: "₹1,19,000", target: "85%",  status: "In Progress" },
  { name: "Sneha Patil",    leads: "98",  conversions: "22", revenue: "₹97,000",   target: "81%",  status: "In Progress" },
  { name: "Rohit Desai",    leads: "87",  conversions: "18", revenue: "₹81,000",   target: "81%",  status: "In Progress" },
];
...
export default function SalesManagerDashboard() {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto space-y-6">
      ...
      {/* Performer: View */}
      <Modal id="performer-view" title="Performer Details" size="md">
        {selectedPerformer && (
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-3">
              <ModalData label="Employee"    value={selectedPerformer.name} />
              <ModalData label="Leads"       value={selectedPerformer.leads} />
              <ModalData label="Conversions" value={selectedPerformer.conversions} />
              <ModalData label="Revenue"     value={selectedPerformer.revenue} />
              <ModalData label="Target %"    value={selectedPerformer.target} />
              <ModalData label="Status"      value={selectedPerformer.status} />
            </div>
            <div className="flex justify-end pt-2">
              <Button text="Close" variant="ghost" size={3} onClick={() => closeModal("performer-view")} />
            </div>
          </div>
        )}
      </Modal>
