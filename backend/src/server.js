...
const salesTeamLeaderProspectRoutes = require('./routes/salesTeamLeaderProspects');
const salesTeamLeaderFollowUpRoutes = require('./routes/salesTeamLeaderFollowUps');
...
try {
	...
	app.use('/api/sales-team-leader/prospects', salesTeamLeaderProspectRoutes);
	console.log('✓ /api/sales-team-leader/prospects routes registered');
	app.use('/api/sales-team-leader/follow-ups', salesTeamLeaderFollowUpRoutes);
	console.log('✓ /api/sales-team-leader/follow-ups routes registered');
